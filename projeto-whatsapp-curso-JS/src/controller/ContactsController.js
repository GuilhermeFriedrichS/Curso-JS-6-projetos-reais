...
export class ContactsController extends ClassEvent{
    ...
    constructor(nodalEl, user){
        
        super();

        this._user = user;
        this._modalEl = nodalEl;
    ...
    open(){
        ...
        User.getContactsRef(this._user.email).where('name', '>=', '').onSnapshot(contacts =>{
            ...
            contacts.forEach(contact => {
                        ...
                        <div tabindex="-1">
                            <div class="_2EXPL aZ91u">
                                ...
                                <div class="_3j7s9">
                                    <div class="_2FBdJ">
                                        <div class="_25Ooe">
                                            <span dir="auto" class="_1wjpf contact-name">${contactData.name}</span>
                                        </div>
                                    </div>
                                    <div class="_1AwDx">
                                        <div class="_itDl"></div>
                ...
                div.on('click', e => {
                    ...
                    this.trigger('select', contactData);
                    this.close();
